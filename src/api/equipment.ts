...
export async function terminalBind(params: any) {
  return request({
    url: '/monitor/device/terminal/bind',
    method: 'post',
    data: params,
  });
}
...
export async function terminalUnbind(params: any) {
  return request({
    url: `/monitor/device/terminal/unbind/${params}`,
    method: 'post',
  });
}
...
export async function terminalAdd(params: any) {
  return request({
    url: '/monitor/device/terminal/save',
    method: 'post',
    data: params,
  });
}
...
export async function terminalCheck(params: any) {
  return request({
    url: '/monitor/device/terminal/confirm',
    method: 'post',
    data: params,
  });
}
...
export async function terminalType(params: any) {
  return request({
    url: '/monitor/device/terminal/clienttypes',
    method: 'post',
    data: params,
  });
}
...
export async function terminalCfg(params: any) {
  return request({
    url: `/monitor/device/terminal/cfg/${params}`,
    method: 'get',
  });
}
...
export async function getCarList(params: any) {
  return request({
    url: '/monitor/device/vehicle/list',
    method: 'post',
    data: params,
  });
}
...
export async function findCar(params: any) {
  return request({
    url: '/monitor/device/vehicle/platenum',
    method: 'get',
    data: params,
  });
}
